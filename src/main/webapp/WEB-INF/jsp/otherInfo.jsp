                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <h6 class="card-subtitle">
                                                <%= fpersonne.getReligion().getName() %>
                                            </h6>
                                        </div>
                                        <div class="mt-3">
                                            <h4 class="card-title">Couleur</h4>
                                            <h6 class="card-subtitle">
                                                <%= fpersonne.getCouleur().getName() %>
                                            </h6>
                                        </div>
                                        <div class="mt-3">
                                            <h4 class="card-title">Contact</h4>
                                            <h6 class="card-subtitle">
                                                <%= fpersonne.getContact() %>
                                                </h6>
                                        </div>
                                        <div class="mt-3">
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <h6 class="card-subtitle">
                                                <%= fpersonne.getDiplome().getName() %></h6>
                                        </div>
                                        <div class="mt-3">
                                            <h4 class="card-title">Fréquence à l'église</h4>
                                            <h6 class="card-subtitle">
                                                <%= fpersonne.getFrequence() %></h6>
                                        </div>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="mt-3">
                                            <h4 class="card-title">Analyse du système</h4>
                                            <h6 class="card-subtitle">
                                                <%= fpersonne.evaluate() %>
                                            </h6>
                                        </div>
                                ...
                                <div class="row mt-3">
                                    <div class="col-6">
                                        <a href="/rencontre/personne/marquer/<%= id %>/<%= fpersonne.getId()%>" class="btn btn-block btn-warning">Marquer comme consulté</a>
                                    </div>
                                </div>
                            </div>
                        </div>
